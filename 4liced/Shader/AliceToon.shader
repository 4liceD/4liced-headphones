...
Shader "4liceD/AliceToon mra"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			s20.Emission = ( _EmissionColor * tex2D( _Emission, uv_Emission ) ).rgb;
...
ASEEND*/
//CHKSM=CEE477D17599287E04C4C29111A95F703AFD6A47